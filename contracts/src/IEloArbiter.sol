...
/// @title IEloArbiter — the dispute court interface (the honest "AI court")
...
interface IEloArbiter {
    ...
    function rule(uint256 jobId, bytes32 specHash, bytes32 deliveredHash) external returns (Verdict);
}
