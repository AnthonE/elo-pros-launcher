...
/// @title ScryTicket — burnable mint tickets for the Thousand
...
///            to seed ScryGacha positions, each escrowed with ETH backing.
...
contract ScryTicket is ReentrancyGuard {
    string public constant name = "scry mint tickets - the thousand";
    ...
    /// into ScryGacha with ETH backing. The floor lives THERE, in escrow —
