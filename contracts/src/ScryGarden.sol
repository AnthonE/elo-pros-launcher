...
///         house-minted — and that is the LP whose SEED shares `ScryGardener`
...
///         return this.
///
///         Two consequences, and the first is a bill: **scry owns this pool's
...
///         one.
contract ScryGarden is ReentrancyGuard {
        ...
        returns (uint256 seeds)
    {
        ...
        // see — the exact argument that rewrote `ScryBank.enter`, applied here
