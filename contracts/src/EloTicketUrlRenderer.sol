...
/// @title EloTicketUrlRenderer — a ticket's metadata, served from a URL
/// @notice `EloGameTicket` builds its own `data:application/json` document
