...
/// @title EloDeed — the tabula: a house on a named street, as property
...
///         the VOW at EloReputation, never to the property. Buy the walls and
...
contract EloDeed {
    ...
    function _logo() internal pure returns (string memory) {
        return string.concat(
            ...
            '<text x="175" y="312" text-anchor="middle" fill="#e8e6df" font-family="monospace" font-size="20">reserve deeds</text>',
            "</svg>"
        );
    }
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        ...
        string memory json = string.concat(
            ...
            "reputation is soulbound to the vow at EloReputation and does NOT move with this title. "
