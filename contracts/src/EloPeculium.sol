...
/// @title EloPeculium — sealed policy vault with attestation-quorum signer admission
...
contract EloPeculium {
    ...
    bytes32 private constant NAME_HASH = keccak256("EloPeculiumAdmission");
