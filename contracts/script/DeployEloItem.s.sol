...
/// meaningless floor, and a shared collection makes a `EloGacha` pool's
...
///   # export ITEM_BASE_URI=https://elopros.com
...
///
///   forge script script/DeployEloItem.s.sol \
...
contract DeployEloItem is Script {
    function run() external {
        ...
        string memory baseURI = vm.envOr("ITEM_BASE_URI", string("https://elopros.com/api"));
        ...
        EloItem item = new EloItem(itemName, itemSymbol, receiver, uint96(bps), baseURI);
        ...
        console2.log("EloItem       ", address(item));
