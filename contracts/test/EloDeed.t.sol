...
contract EloDeedTest is Test {
    ...
    // ⚠ RE-PINNED 2026-08-22, and re-pinning is only honest because the
    // change was READ first. This vector is a known answer, so regenerating
    // it from the contract proves nothing by itself — the decoded JSON was
    // checked field by field before it was pasted: name "elo deed #1",
    // "the streets of Elo", the vow at EloReputation, elopros.com.
    // ⚠ The old vector was the pre-rename one, and the sweep that produced
    // its replacement had written "the streets of reserve" — a ROLE dropped
    // into a sentence that wanted a PLACE. A deed is prose a buyer reads;
    // the reserve-not-ticker rule governs rules, never names.
    string constant EXPECTED_URI =
        "data:application/json;base64,";
