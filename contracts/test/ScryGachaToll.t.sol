...
contract ScryGachaTollTest is Test {
    ...
    /// `ScryGacha.t.sol` tests: native ETH, ten `msg.value` reads, no allowance.
    ...
    function test_theRequestPullsTheCoinAndRefusesEther() public {
        ...
        vm.prank(cody);
        vm.expectRevert(ScryGacha.TollRailTakesNoEth.selector);
    ...
    function test_maxFeeCapsTheTollNotTheEthFee() public {
        ...
        vm.prank(cody);
        vm.expectRevert(ScryGacha.FeeAboveCap.selector);
    ...
    function test_aShortDeliveringTollCoinIsRefused() public {
        ...
        vm.prank(cody);
        vm.expectRevert(ScryGacha.TollShortDelivered.selector);
    ...
    function test_theBurnIsAccruedInSettleAndCountedOnlyWhenItLands() public {
        ...
        vm.expectRevert(ScryGacha.NothingToBurn.selector);
        g.sweepBurn();
    }
    ...
    function test_theCoinCannotMoveWhileAnythingIsOutstanding() public {
        ...
        vm.expectRevert(ScryGacha.TollRailNotEmpty.selector);
        g.setToll(address(other), RATE);
        vm.expectRevert(ScryGacha.TollRailNotEmpty.selector);
    ...
    function test_theTollKnobsAreBoundedAndOwnerOnly() public {
        vm.expectRevert(ScryGacha.BurnTooHigh.selector);
        g.setTollBurnBps(2_001);
        g.setTollBurnBps(2_000);

        vm.expectRevert(ScryGacha.RateWithoutCoin.selector);
