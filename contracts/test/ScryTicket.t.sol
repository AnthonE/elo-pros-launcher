...
contract ScryTicketTest is Test {
    ScryTicket tick;
    ...
    function setUp() public {
        tick = new ScryTicket(TRIALS, SNAPSHOT, GACHA, WINDOW, proceeds, 250, "https://scry.moreright.xyz/api");
    ...
    function test_snapshotAllowanceAndTrancheCaps() public {
        ...
        ScryTicket t2 = new ScryTicket(0, 3, 0, WINDOW, proceeds, 0, "x");
    ...
    function test_globalThousandBindsOverAnyPublicCap() public {
        ScryTicket t2 = new ScryTicket(0, 0, 0, WINDOW, proceeds, 0, "x");
    ...
    function test_setEidolonIsOneShot() public {
        ...
        ScryTicket t2 = new ScryTicket(1, 1, 1, WINDOW, proceeds, 0, "x");
        vm.prank(alice);
        vm.expectRevert(bytes("not owner"));
    ...
    function test_metadataAndInterfaces() public {
        ...
        vm.prank(alice);
        uint256 id = tick.claimTrials(1, _soloProof());
        assertEq(tick.tokenURI(id), "https://scry.moreright.xyz/api/ticket/1/metadata");
        assertEq(tick.contractURI(), "https://scry.moreright.xyz/api/ticket/collection");
