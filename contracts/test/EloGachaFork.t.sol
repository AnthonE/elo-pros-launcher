...
/// @title EloGachaFork — the pool against a real RH-Chain collection
...
///         from `reserve-contracts-toolchain` applies — an offline skip-pass costs
///         ~4-6k gas, a real run costs millions. Check it before believing a
///         green line.**
///
///           RH_FORK_URL=https://rpc.mainnet.chain.robinhood.com \
///             forge test --match-contract EloGachaForkTest -vv
contract EloGachaForkTest is Test {
    ...
    function test_fork_whatOnePullActuallyCosts() public {
        ...
        assertLt(pull, 1_500_000, "a pull got expensive - re-read the gas budget in EloGacha.sol before shipping");
    }
