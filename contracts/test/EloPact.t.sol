...
contract EloPactTest is Test {
    ...
    function test_proposeRejectsBadTermsHash() public {
        (address[] memory a, string[] memory r, string[] memory o) = _parties();
        vm.prank(A);
        vm.expectRevert(EloPact.BadTextHash.selector);
    ...
    function test_proposeRejectsTooFewParties() public {
        ...
        o[0] = "do it";
        vm.prank(A);
        vm.expectRevert(EloPact.BadParties.selector);
    ...
    function test_proposeRejectsDuplicateParty() public {
        ...
        o[1] = "b";
        vm.prank(A);
        vm.expectRevert(EloPact.DuplicateParty.selector);
    ...
    function test_outsiderCannotSignOrComment() public {
        _propose();
        vm.prank(C);
        vm.expectRevert(EloPact.NotAParty.selector);
        p.sign(pid);
        vm.prank(C);
        vm.expectRevert(EloPact.NotAParty.selector);
    ...
    function test_partyCannotSignTwice() public {
        _propose();
        vm.prank(A);
        vm.expectRevert(EloPact.AlreadySigned.selector);
    ...
    function test_commentEmitsText() public {
        ...
        emit EloPact.PactComment(pid, B, "audit underway, on track for 48h", 1500);
        vm.prank(B);
    ...
    function test_eachPartyAssertsOwnStatus() public {
        ...
        // both views coexist on-chain; reserve never reduces them to one verdict
    ...
    function test_proposeIsOnce() public {
        ...
        (address[] memory a, string[] memory r, string[] memory o) = _parties();
        vm.prank(A);
        vm.expectRevert(EloPact.PactExists.selector);
    ...
    function test_brokerProposeEmitsFullPayload() public {
        ...
        vm.warp(1000);
        vm.expectEmit(true, true, false, true);
        emit EloPact.PactProposed(pid, C, th, "brokered", terms, a, r, o);
        vm.prank(C);
        p.propose(pid, th, "brokered", terms, a, r, o);
    }
    ...
    function test_autoSignEmitsSignedBeforeProposed() public {
        ...
        vm.warp(1000);
        vm.expectEmit(true, true, false, true);
        emit EloPact.PactSigned(pid, A, 1, 1000);
        vm.expectEmit(true, true, false, true);
        emit EloPact.PactProposed(pid, A, th, "audit-for-pay", terms, a, r, o);
        vm.prank(A);
        p.propose(pid, th, "audit-for-pay", terms, a, r, o);
    }
    ...
    function test_proposeAtPostedMaxSizes() public {
        ...
        vm.warp(1000);
        vm.expectEmit(true, true, false, true);
        emit EloPact.PactProposed(pid, C, maxHash, maxTitle, maxTerms, a, r, o);
        vm.prank(C);
