...
contract EloNotaryTest is Test {
    ...
    function test_notarizedEventFirstCommitAndRivalRecommit() public {
        ...
        emit EloNotary.Notarized(momo, h, "prediction: ETH > 3500 fri", "sworn by momo-9", 1000, 1, true);
        vm.prank(momo);
        ...
        vm.warp(1100);
        vm.expectEmit(true, true, false, true);
        emit EloNotary.Notarized(rival, h, "prediction: ETH > 3500 fri", "late echo", 1100, 2, false);
        vm.prank(rival);
