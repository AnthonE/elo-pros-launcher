...
contract EloGardenBurrowTest is Test {
    ...
    function setUp() public {
        ...
        garden = new EloGarden(IERC20(address(gold)), IERC20(address(tears)));
        burrow = new EloBurrow(IERC20(address(gold)), IERC20(address(tears)), IGardenOracle(address(garden)));
    ...
    /// reserve reads and the posted FEE_BPS = 30 (EloGarden.sol):
    ...
    /// and back on 2026-07-27; EloGarden.sol's notice carries why 0.3% is the
