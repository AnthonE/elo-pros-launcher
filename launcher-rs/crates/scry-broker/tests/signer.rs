...
use scry_broker::signer::{ArcaSigner, BrowserSigner, ExternalSigner, NoSigner, Signer};
...
fn the_browser_hands_off_rather_than_failing() {
    ...
    assert!(url.starts_with("https://scry.moreright.xyz/play.html"),
...
fn an_unplaceable_family_goes_somewhere_that_exists() {
    assert_eq!(BrowserSigner::page_for("scry play\n…"), "play.html");
    assert_eq!(BrowserSigner::page_for("scry review\n…"), "reviews.html");
    assert_eq!(BrowserSigner::page_for("scry braid\n…"), "hive.html");
    assert_eq!(BrowserSigner::page_for("scry somethingnew\n…"), "wallet.html");
    assert_eq!(BrowserSigner::page_for("not even a scry message"), "wallet.html");
}
